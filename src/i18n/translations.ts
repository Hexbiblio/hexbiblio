...
export const translations = {
  ...
  "roadmap.currentlyLabel": { en: "Currently:", fr: "En cours :" },
  "roadmap.continueCTA": { en: "Continue the conversation", fr: "Continuer la conversation" },
  "roadmap.planCTA": { en: "Add my plan", fr: "Renseigner mon plan" },
  "roadmap.sourcesLink": { en: "Browse sources", fr: "Explorer les sources" },
