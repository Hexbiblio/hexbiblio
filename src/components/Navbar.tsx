...
import { Search, Upload, Bookmark, User, LogOut, Globe, Menu, Check, BookOpen, Compass, Moon, Sun, ShieldCheck } from "lucide-react";
...
const Navbar = () => {
  ...
  const links = [
    ...
    { to: "/roadmap", label: t("nav.roadmap"), icon: Compass },
